...
define('ember-app/mixins/regenerated/models/i-i-s-kyrs11-\u043F\u043E\u043A\u0443\u043F-\u0438\u043B\u0438-\u0432\u043E\u0437\u0432-\u0431', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    ...
    modelClass.defineProjection('ПокупИлиВозвБL', 'i-i-s-kyrs11-покуп-или-возв-б', {
      ...
      статус: (0, _attributes.attr)('Статус', { index: 6 }),
      перевозчик1: (0, _attributes.belongsTo)('i-i-s-kyrs11-перевозчик1', '', {}, { index: 3 }),
      покупкаБилета: (0, _attributes.hasMany)('i-i-s-kyrs11-покупка-билета', 'Покупка билета', {
        покупатель: (0, _attributes.belongsTo)('i-i-s-kyrs11-покупатель', 'Покупатель', {
          банковскийСчет: (0, _attributes.attr)('Банковский счет', { index: 1 })
        }, { index: 0, displayMemberPath: 'фИО' }),
